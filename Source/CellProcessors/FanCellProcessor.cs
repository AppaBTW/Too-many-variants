...
namespace Indev2
{
    public class FanCellProcessor : TickedCellStepper
    {
        public override string Name => "Fan Cell";
        public override int CellType => 44;
        public override string CellSpriteIndex => "Fan";

        public FanCellProcessor(ICellGrid cellGrid) : base(cellGrid)
        {
        }
